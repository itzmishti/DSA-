...
<head>
    ...
    <style>
        ...
        .header {
            background-color: #242562; /* Updated to match the new color */
            color: white;
            width: 100%;
            padding: 15px;
            text-align: center;
        ...
        .top-bar {
            background-color: #1b2781; /* Updated to match the new color */
            color: white;
            padding: 15px;
            text-align: center;
            font-size: 24px;
        ...
        .loader {
            ...
            border-radius: 50%;
            border-top: 4px solid #1b2781; /* Updated to match the new color */
            width: 30px;
            height: 30px;
